...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-032-a-exercise-solar-system.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-032-a-exercise-solar-system`
  ...
  - Agora, crie uma branch à qual você vai submeter os `commits` de seu projeto.
    ...
    - Exemplo: `git checkout -b joaozinho-sd-032-a-exercise-solar-system>`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-032-a-exercise-solar-system`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-032-a-exercise-solar-system/pulls).
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-032-a-exercise-solar-system/pulls) e confira se seu _Pull Request_ está criado.
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH32-A&template=betrybe/sd-0x-exercise-solar-system)
